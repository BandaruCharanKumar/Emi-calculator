      ...
      <div className="w-full max-w-3xl p-4">
        <form className="grid grid-cols-1 md:grid-cols-2 gap-4 p-6 bg-white  rounded shadow-lg ring-2 ring-[#40ccb3]">
          <div className="relative">
            <label htmlFor="productPrice" className=" text-black block mb-1 text-md font-semibold">
              Product Price(₹):
            </label>
            <div className=" input-container">
              <input
                ...
                className="w-full p-2 border text-black rounded hover:border-[#40ccb3] focus:border-[#40ccb3]"
          ...
          <div className="relative">
            <label htmlFor="processingCharges" className="text-black block mb-1 text-md font-semibold">
              processing Charges(%):
            </label>
            <div className="input-container">
              <input
                ...
                className="w-full p-2 border text-black rounded hover:border-[#40ccb3]"
                placeholder=' 5%'
              />
              <span className="calculated-value text-black bg-gray-300 text-sm rounded p-3 absolute right-0 bottom-0 text-center">
              ₹{processingFee}
              </span>
            </div>
          </div>
          <div className="relative">
            <label htmlFor="fileCharges" className=" text-black block mb-1 text-md font-semibold">
              File Charges(%):
            </label>
            <div className="input-container">
              <input
          ...
          <div className="relative">
            <label htmlFor="dbdValue" className=" text-black block mb-1 text-md font-semibold">
              DBD Value(%):
            </label>
            <div className="input-container">
              <input
                ...
                placeholder=' 4%'
              />
               <span className="calculated-value bg-gray-300 text-black text-sm rounded p-3 absolute right-0 bottom-0 text-center">
               ₹{dbdChargeFee}
              </span>
            </div>
          </div>
          ...
          <div className="relative">
            <label htmlFor="interestrate" className=" text-black block mb-1 text-md font-semibold">
              Flat Interest Fee(%):
            </label>
            <div className="input-container">
              <input
                ...
                className="w-full p-2 border rounded text-black hover:border-[#40ccb3]"
                placeholder=' 5%'
              />
              <span className="calculated-value bg-gray-300 text-black text-sm rounded p-3 absolute right-0 bottom-0 text-center">
              ₹{flatInterestFee}
          ...
          <div className="relative">
            <label htmlFor="downPayment" className=" text-black block mb-1 text-md font-semibold">
              Down Payment Fee(₹):
            </label>
            <div className="input-container">
              <input
          ...
          <div>
            <label className="block mb-1 text-black text-md font-semibold">Gross LoanAmount (₹) : </label>
            <input className="w-full p-2 border text-black rounded hover:border-[#40ccb3]"
             readOnly value={grossLoanAmount} />
          </div>

          <div className="relative">
            <label htmlFor="noOfEmis" className="block text-black mb-1 text-md font-semibold">
              No Of EMIs:
            </label>
            <div className="input-container">
              <input
          ...
          <div>
            <label className="block mb-1 text-md text-black font-semibold">Monthly Emi (₹) : </label>
            <input className="w-full p-2 border text-black rounded hover:border-[#40ccb3]"
